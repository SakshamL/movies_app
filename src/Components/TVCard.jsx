...
function TVCard(props) {
  return (
    <div className=" text-white flex flex-col w-[12%]  brightness-[1.25] rounded-[10px] border-[#80808000] border-[5px]  focus:scale-[1.3]  hover:scale-[1.1] hover:border-[5px] hover:border-[#bdbdbde9] hover:z-10 focus:z-10 transition duration-200  max-sm:w-[45%] max-sm:hover:scale-[1.1] max-md:w-[30%] max-md:hover:scale-[1.1] max-lg:w-[22%] max-lg:hover:scale-[1.1]">
      <Link
        to={`/tv/${props.id}`}
        className="rouned-[10px] focus:outline-[5px] focus:outline-[#bdbdbde9] focus:rounded focus:scale-[1.1] transition duration-200"
      >
        <img
